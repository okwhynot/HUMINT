...
public class ObjectEditor : Editor
{
    ...
    {
        ShowOnEnum("objectType","Player","player"); //player is only visible when objectType == Player
        ShowOnEnum("objectType","NPC","npc"); //npc is only visible when objectType == NPC
		  ShowOnEnum("objectType","Item","item"); //item is only visible when objectType == Item
    }
    /////////////////////////////////////////////////////////
    ...
    /////////////////////////////////////////////////////////            
    /// <summary>
    /// Use this function to set when which fields should be visible.
    /// </summary>
